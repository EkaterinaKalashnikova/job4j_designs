...
VALUES (1, 'Петр','Егоров', 27, 'Россия'),
       (2, 'Елена','Иванченко', 36, 'Белоруссия'),
       (3, 'Марк','Рубинштейн', 31, 'Израиль'),
       (4, 'Мигель','Педро', 43, 'Испания'),
       (5, 'Эмма','Смит', 39, 'Англия'),
       (6, 'Роми','Глен', 51, 'Ирландия');
